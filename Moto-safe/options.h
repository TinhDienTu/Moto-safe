 ...
 *   UART_LETTER = A     UART_MODULE = 0    */
  ...
  #define UART_LETTER       A     /* Currently, use UART module USCI_A1 */
#ifdef UART_F5xx
 ...
 *   On MSP430G2553 Experimenter Board, to map to RS-232:
 *   TX pin = P1.2     RX pin = P1.1
 *   On MSP430F5529 Daughter Board for SmartRF�05 board, to map to RS-232:
 *   TX pin = P4.4     RX pin = P4.5     */
#ifndef UART_F5xx
...
#else
  #define UART_TX_PORT_NUM  4
  #define UART_TX_BIT_NUM   4
  #define UART_RX_PORT_NUM  4
 ...
 *   CTS pin = P2.7    RTS pin = P2.6       */
  ...
  #define UART_CTS_PORT_NUM 1    /* If flow control is ON, these two pins     */
  #define UART_CTS_BIT_NUM  7    /* will be mapped as CTS and RTS, otherwise  */
  #define UART_RTS_PORT_NUM 6    /* these pins will be left unmapped          */
  #define UART_RTS_BIT_NUM  7
